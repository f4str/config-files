# Generated by Powerlevel10k configuration wizard on 2022-01-08 at 20:50 EST.
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_VIRTUALENV_VISUAL_IDENTIFIER_EXPANSION='($(basename "$VIRTUAL_ENV"))'
